...
public class AllotmentDto {
    ...
    public AllotmentDto(Integer allotmentId, String multiplexName, String movieName, Date availableFrom, Date availableTo, String screenName, int movieId,
                        int multiplexId,int ticketCost) {
